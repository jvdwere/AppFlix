...
import { Flex, Text, Image, Box, Heading, Button, ButtonGroup, Grid, SimpleGrid } from "@chakra-ui/react"
...
export default function Movie() {
    ...
    const handleTimeMovie = () => {
        const tempo = state?.runtime
        const resultado = tempo / 60
        const TFilme = resultado.toFixed(2).replace('.', ':')
        return TFilme
    }
                    ...
                    <Box>
                        <Box width={"70%"} mt="200px">
                            <Box w={"750px"}>
                                ...
                                <Text color={"white"} fontSize={'9pt'} mt='10px'>Tempo de filme:  {handleTimeMovie()}</Text>
